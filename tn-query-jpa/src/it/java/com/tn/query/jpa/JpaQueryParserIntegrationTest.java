...
import static com.tn.query.Mapper.toBoolean;
import static com.tn.query.Mapper.toByte;
import static com.tn.query.Mapper.toChar;
import static com.tn.query.Mapper.toDate;
import static com.tn.query.Mapper.toDouble;
import static com.tn.query.Mapper.toLocalDate;
import static com.tn.query.Mapper.toLocalDateTime;
import static com.tn.query.Mapper.toLong;
import static com.tn.query.Mapper.toShort;
...
class JpaQueryParserIntegrationTest
{
  ...
  static class TestConfiguration
  {
    ...
    TargetRepositoryImpl targetRepositoryImpl(EntityManager entityManager)
    {
      ...
      Map<String, Expression<?>> nameMappings = new HashMap<>();
      nameMappings.put("booleanValue", targetRoot.get("booleanValue"));
      nameMappings.put("byteValue", targetRoot.get("byteValue"));
      nameMappings.put("charValue", targetRoot.get("charValue"));
      nameMappings.put("dateValue", targetRoot.get("dateValue"));
      nameMappings.put("doubleValue", targetRoot.get("doubleValue"));
      nameMappings.put("intValue", targetRoot.get("intValue"));
      nameMappings.put("localDateValue", targetRoot.get("localDateValue"));
      nameMappings.put("localDateTimeValue", targetRoot.get("localDateTimeValue"));
      nameMappings.put("longValue", targetRoot.get("longValue"));
      nameMappings.put("shortValue", targetRoot.get("shortValue"));
      nameMappings.put("stringValue", targetRoot.get("stringValue"));
      ...
      return new TargetRepositoryImpl(
        ...
        new JpaQueryParser(
          ...
          List.of(
            ...
            toDouble("intValue"),
            toLocalDate("localDateValue"),
            toLocalDateTime("localDateTimeValue"),
            toLong("longValue"),
            toShort("shortValue")
          )
        )
